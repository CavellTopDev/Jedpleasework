...
const BookingDate: NextPage = () => {
    return (
        <div className="absolute top-[3653px] left-[280px] rounded-[5px] w-[845.8px] h-[502px] overflow-hidden text-smi-9 text-slategray font-body-1-medium border-[1px] booking">
